        ...
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link href="/cart" className="relative text-gray-400 hover:text-[var(--accent)] transition-colors p-1.5">
              <svg className="w-5 h-5 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
              </svg>
              {itemCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-[var(--accent)] text-white text-[9px] sm:text-[10px] font-bold rounded-full w-4 h-4 sm:w-4 sm:h-4 flex items-center justify-center shadow-lg shadow-[var(--accent-glow)]">
                  {itemCount}
                </span>
              )}
            </Link>
            ...
            <button
              ...
              className="md:hidden text-gray-400 hover:text-[var(--accent)] p-1.5"
