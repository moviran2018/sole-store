    ...
    <div className="pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <p className="text-[10px] uppercase tracking-[0.3em] text-[var(--accent)] font-medium mb-4">About Us</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          <div className="aspect-square bg-[var(--muted)] overflow-hidden card-3d">
            <div className="w-full h-full bg-gradient-to-br from-orange-900/30 to-black flex items-center justify-center">
              <span className="text-6xl opacity-20">👟</span>
            </div>
          </div>
          <div>
            <h2 className="text-xl font-bold text-white mb-4">کیفیت، اولویت اول ما</h2>
            ...
            <Link href="/#products" className="inline-flex items-center px-5 py-2.5 btn-primary text-xs font-semibold tracking-wider uppercase">
              مشاهده محصولات
            </Link>
          </div>
        </div>
