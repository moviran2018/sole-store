...
const products = rawShoes.map((s, i) => ({
  id: s.id,
  name: s.name,
...
const outDir = join(__dirname, "products.json");
...
writeFileSync(outDir, JSON.stringify(output, null, 2), "utf-8");
console.log(`Written ${products.length} products to ${outDir}`);
